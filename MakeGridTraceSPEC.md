...
> **注**: JSON 形式は別紙 **「スリザーリンク マップデータ仕様書 v1.0」** に従うこと。
...
| H‑6 | **最小ヒント数** — 空白セルのみの出力は禁止（難易度に応じて下限設定） | ヒント数 ≧ MIN\_HINTS\[difficulty]            |
...
| 制限時間超過    | 現ステップ破棄、全行程をリトライ（最大 RETRY\_LIMIT 回） |
...
* Nikoli 本家ルール解説
* Academic paper: *Generating Unambiguous Slitherlink Puzzles via Constraint Programming*, 2023

---

*本仕様に関する質問は Slack #slitherlink-dev まで*
